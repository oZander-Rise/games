...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			...
			en_us: 'Want to download this game? Just tap %icon and then <strong>Add to Home Screen</strong>.',
			...
			ru_ru: 'Хотите установить игру? Нажмите %icon, затем <strong>Добавить на экран «Домой»</strong>.',
	...
	function init () {
		...
		isSessionActive = false && w.sessionStorage.getItem('addToHomeSession');
	...
	function show () {
		...
		if ( options.closeButton ) {
			...
			balloon.addEventListener('touchstart', clicked, false);
		}
	}
	...
	function close () {
		...
		if ( options.closeButton ) {
			...
			balloon.removeEventListener('touchstart', clicked, false);
		}
